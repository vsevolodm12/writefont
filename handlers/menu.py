...
- Никогда не используй оформление в стиле mardown файла (например: **жирный текст / *косой текст / --- разделяющая линия и тд)
...
- Не пиши ответ на вопрос в начале ответа, а так же заключение в конце ответа например: (начало) «Понял, отправлю решение этой работы» и тд, (конец) «Можешь смело отправлять эту работу на генерацию» и тд. Только решение работы
