...
- Загрузка нескольких TTF/OTF шрифтов для вариативности
- Случайный выбор шрифта для каждого слова (эффект живого почерка)
- Генерация PDF в формате A4 или A5
- Фоновая сетка (тетрадный стиль)
